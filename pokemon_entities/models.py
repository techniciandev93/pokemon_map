...
class Pokemon(models.Model):
    ...
    title_en = models.CharField(max_length=200, verbose_name='Наименование на Английском')
    title_jp = models.CharField(max_length=200, verbose_name='Наименование на Японском')
    ...
    image = models.ImageField(upload_to='images/pokemons', null=True, verbose_name='Изображение')
